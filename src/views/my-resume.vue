    ...
    <template v-if="resumeId > 0">
      ...
      >
        <img
          ...
          :src="filterImgSrc(personalInfos.avatarUrl)"
          alt="个人头像"
        />
        <div class="infos">
      ...
      <section v-if="educations" item-type="educations" class="educations">
        ...
        >
          <img v-if="item.logoUrl" :src="filterImgSrc(item.logoUrl)" />
          <div class="sg-flex-one">
          ...
          <template v-if="editItemType === 'personalInfos'">
            ...
            >
              ...
              <div v-if="item.type === 'image'">
                <img
                  :src="filterImgSrc(personalInfos[item.key])"
                  alt="个人头像"
                />
            ...
            >
              ...
              >
                ...
                <div v-if="item_.type === 'image'">
                  <img :src="filterImgSrc(item[item_.key])" alt="图片" />
...
import { imgSrcFilter } from "@/filters/index";
...
export default defineComponent({
  ...
  components: {
    ImageEditor: () => import("@/components/image-editor.vue"),
  },
  ...
  methods: {
    ...
    setResumeData(data = {}) {
      this.resumeModuleKeys.forEach((key) => {
        if (data[key]) {
          try {
            const v = data[key];
            let o;
            if (o && typeof v === "object") {
    ...
    createResume(userData) {
      const data = {};
      const object = userData || DEFAULT_RESUME;
