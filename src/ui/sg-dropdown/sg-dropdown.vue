    ...
    <div class="option-label sg-flex" @click.stop="onToggle">
      <div class="sg-flex-one sg-ellipsis">
        <slot>
          <span
            :class="{
              'option-tip': !currentLabel,
              'current-label': optionActive && !!currentLabel,
            }"
      ...
      <div class="sg-options" sg-scroll="vertical_stop">
        <div class="options-inner">
          <div
            ...
            :class="{
              'option-active': optionActive && currentValue === item.value,
            }"
